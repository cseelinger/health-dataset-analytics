...
# ----------------------------------------------------------------
def query_smokers_hypertension(data):
    """
...
#      Grouped by gender
# ----------------------------------------------------------------
def query_hypertension_stroke_by_gender(data):
    """
    Returns the mean, modal and median ages of patients,
...
# ----------------------------------------------------------------
def query_averages_physical_activity_level(data):
    """
...
# ----------------------------------------------------------------
def query_urban_vs_rural_areas_with_stroke(data):
    """
